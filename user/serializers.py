...
class DirectorSerializer(serializers.ModelSerializer):
    ...
    # user=serializers.StringRelatedFieldField(read_only=True)
...
class CustomerAuthSerializer(serializers.Serializer):
    ...
    def get_token(self,customer):
        token,created=Token.objects.get_or_create(customer.user)
        return token.key
...
class DirectorAuthSerializer(serializers.Serializer):
    ...
    def get_token(self,director):
        token,created=Token.objects.get_or_create(director.user)
        return token.key
